...
export default function BlogForm({ formData, errors, onInputChange, isDark }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className={`rounded-xl border p-5 ${isDark ? "bg-gray-800 border-rose-500/60" : "bg-white border-rose-300"}`}>
        <div className="flex items-center gap-2 mb-4">
          <div className={`p-1.5 rounded-lg ${isDark ? "bg-red-900/50" : "bg-red-100"}`}>
            <FileText className={`w-4 h-4 ${isDark ? "text-red" : "text-red"}`} />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2 rounded-lg border transition-all duration-200 focus:ring-2 focus:ring-red/20 focus:outline-none ${
                errors.title
                  ? "border-red-500"
                  : isDark
      ...
      <div className={`rounded-xl border p-5 ${isDark ? "bg-gray-800 border-rose-500/60" : "bg-white border-rose-300"}`}>
        <div className="flex items-center gap-2 mb-4">
          <div className={`p-1.5 rounded-lg ${isDark ? "bg-red-900/50" : "bg-red-100"}`}>
            <Globe className={`w-4 h-4 ${isDark ? "text-red" : "text-red"}`} />
          </div>
          <h2 className={`text-lg font-semibold ${isDark ? "text-gray-50" : "text-gray-950"}`}>
            SEO Settings
          </h2>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={2}
              className={`w-full px-3 py-2 rounded-lg border transition-all duration-200 resize-none focus:ring-2 focus:ring-red/20 focus:outline-none ${
                errors.metadesc
                  ? "border-red-500"
                  : isDark
                    ? "bg-gray-700 border-rose-500/50 text-white focus:border-rose-400"
